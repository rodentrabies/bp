...
disk. EC-based cryptographic operations are implemented as FFI
bindings to the [secp256k1] using [cffi], while hash-functions are
...
``` cl
CL-USER> (let ((block (bp:get-block "00000000000000d0dfd4c9d588d325dce4f32c1b31b7c0064cba7025a9b9adcc")))
           (bp:validate
